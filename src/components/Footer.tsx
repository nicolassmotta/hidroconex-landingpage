import logo from "@/assets/logo-hidroconex.jpeg";
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:contato@hidroconex.com.br" className="text-secondary-foreground/70 text-sm hover:text-primary transition-colors">
